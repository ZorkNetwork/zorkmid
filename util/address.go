...
import (
	...
	"github.com/ZorkNetwork/zorkmid/util/bech32"
)
...
var stringsToBech32Prefixes = map[string]Bech32Prefix{
	"zork":     Bech32PrefixKaspa,
	"zorkdev":  Bech32PrefixKaspaDev,
	"zorktest": Bech32PrefixKaspaTest,
	"zorksim":  Bech32PrefixKaspaSim,
}
