...
import (
	...
	"github.com/ZorkNetwork/zorkmid/cmd/wallet/libwallet/bip32"
	"github.com/ZorkNetwork/zorkmid/cmd/wallet/utils"
...
func create(conf *createConfig) error {
	...
	fmt.Printf("Notice the above is neither a secret key to your wallet " +
		"(use \"wallet dump-unencrypted-data\" to see a secret seed phrase) " +
		"nor a wallet public address (use \"wallet new-address\" to create and see one)\n\n")
	...
	if len(signerExtendedPublicKeys) > 0 {
		cosignerIndex, err = libwallet.MinimumCosignerIndex(signerExtendedPublicKeys, extendedPublicKeys)
		if err != nil {
			return err
		}
	}
