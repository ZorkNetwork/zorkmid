...
import (
	...
	"github.com/ZorkNetwork/zorkmid/cmd/wallet/daemon/client"
...
func sweep(conf *sweepConfig) error {
	...
	publicKeybytes, err := libwallet.PublicKeyFromPrivateKey(privateKeyBytes)
	if err != nil {
		return err
	}
	...
	UTXOs, err := libwallet.WalletdUTXOsTolibwalletUTXOs(getExternalSpendableUTXOsResponse.Entries)
	if err != nil {
		return err
	}
