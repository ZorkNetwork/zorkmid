...
file that is automatically parsed when zorkmid starts up. By default, the
configuration file is located at ~/.zorkcoin/zorkmid.conf on POSIX-style operating
systems and %LOCALAPPDATA%\zorkcoin\zorkmid.conf on Windows. The -C (--configfile)
